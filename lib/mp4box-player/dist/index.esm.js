import { Log, createFile, VTTin4Parser, XMLSubtitlein4Parser, Textin4Parser, DataStream } from '@knide/mp4box';
...
class Downloader {
  ...
  getFile = () => {
    ...
    bufferFetcherThenable
      .then(function ({ buffer, totalLength }) {
...
export { Downloader, Mp4boxPlayer, PlayerControls };
